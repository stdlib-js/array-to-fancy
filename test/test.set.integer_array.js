...
tape( 'the function returns an array-like object supporting integer array assignment (generic)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
	...
	idx = array2fancy.idx( new Int32Array( [ 0, 1 ] ) );
	expected = [ 5, 6, 3, 4 ];
	y[ idx ] = [ 5, 6 ];
...
tape( 'the function returns an array-like object supporting integer array assignment ("unknown" dtype, accessor)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting integer array assignment (int32)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting integer array assignment (uint32)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting integer array assignment (float64)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting integer array assignment (float16)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting integer array assignment (complex128)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
	...
	y[ idx ] = new Complex128Array( [ 17, 18, 19, 20 ] );
...
tape( 'the function returns an array-like object supporting broadcasted integer array assignment (generic, array)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting broadcasted integer array assignment (generic, scalar)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting broadcasted integer array assignment (float64, array)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting broadcasted integer array assignment (float64, scalar)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting broadcasted integer array assignment (int32, array)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting broadcasted integer array assignment (int32, scalar)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting broadcasted integer array assignment (uint32, array)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting broadcasted integer array assignment (uint32, scalar)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting broadcasted integer array assignment (complex128, array)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting broadcasted integer array assignment (complex128, complex scalar)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting broadcasted integer array assignment (complex128, real scalar)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
...
tape( 'the function returns an array-like object supporting casting (complex128, complex64)', opts, function test( t ) {
	...
	idx = array2fancy.idx( new Int32Array( [ 0, 1 ] ) );
	expected = new Complex128Array( [ 17, 18, 19, 20, 5, 6, 7, 8 ] );
	y[ idx ] = new Complex64Array( [ 17, 18, 19, 20 ] );
...
tape( 'by default, the function returns an array-like object which throws an error when provided an integer array containing an index which is out-of-bounds (generic)', opts, function test( t ) {
	var idx;
	var x;
	var y;
	var i;
	...
	for ( i = 0; i < 10; i++ ) {
		idx = array2fancy.idx( [ x.length+i ] );
		t.throws( badValue( idx ), RangeError, 'throws an error when provided ' + idx.data );
	}
	t.end();
...
tape( 'by default, the function returns an array-like object which throws an error when provided an integer array containing an index which is out-of-bounds (typed)', opts, function test( t ) {
	var idx;
	var x;
	var y;
	var i;
...
tape( 'when `strict` is `true`, the function returns an array-like object which throws an error when provided an integer array containing an index which is out-of-bounds (generic)', opts, function test( t ) {
	var idx;
	var x;
	var y;
	var i;
...
tape( 'when `strict` is `true`, the function returns an array-like object which throws an error when provided an integer array containing an index which is out-of-bounds (typed)', opts, function test( t ) {
	var idx;
	var x;
	var y;
	var i;
...
tape( 'when `strict` is `false`, the function returns an array-like object which throws an error when provided an integer array containing an index which is out-of-bounds (generic)', opts, function test( t ) {
	var idx;
	var x;
	var y;
	var i;
...
tape( 'when `strict` is `false`, the function returns an array-like object which throws an error when provided an integer array containing an index which is out-of-bounds (typed)', opts, function test( t ) {
	var idx;
	var x;
	var y;
	var i;
