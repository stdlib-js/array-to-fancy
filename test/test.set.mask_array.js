...
tape( 'the function returns an array-like object supporting mask array assignment (float16)', opts, function test( t ) {
	var expected;
	var idx;
	var x;
	var y;
	...
	y[ idx ] = new Float16Array( [ 5, 6, 0, 0 ] );
	...
	y[ idx ] = new Float16Array( [ 0, 5, 6, 0 ] );
	...
	y[ idx ] = new Float16Array( [ 5, 0, 6, 0 ] );
