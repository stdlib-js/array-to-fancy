...
tape( 'the function returns an array-like object supporting slice assignment (float16)', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var s;
