...
```javascript
array2fancy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-to-fancy@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-to-fancy@v0.2.2-umd/browser.js"></script>
```
